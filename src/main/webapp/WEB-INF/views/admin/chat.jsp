        ...
        <main class='main-content bgc-grey-100' style="background-color: #000000!important">
          <div id='mainContent'>
            <div class="full-container">
              <div class="peers fxw-nw pos-r">
                ...
                <div class="peer bdR" id="chat-sidebar">
                  <div class="layers h-100">
                    ...
                    <div class="layer w-100 fxg-1 scrollable pos-r">
                      ...
                      <div class="peers fxw-nw ai-c p-20 bdB bgc-white bgcH-grey-50 cur-p">
                        <div class="peer">               
                          <a href="#chat-b" onclick="$('#chat-b').trigger('click')" >asdas
                          <img src="https://randomuser.me/api/portraits/men/2.jpg" src="#chat-b" alt="" class="w-3r h-3r bdrs-50p">
                          </a>
                        </div>
                        <div class="peer peer-greed pL-20">
                ...
                <!-- Chat Box  2 -->
                <div class="peer peer-greed" id='chat-b'>
                  <div class="layers h-100">
                ...
                <div class="peer peer-greed" id='chat-box'>
                  <div class="layers h-100">
                        ...
                        <div class="peers fxw-nw ai-fe">
                          ...
                          <div class="peer peer-greed ord-0">
                            <div class="layers ai-fe gapY-10">
                              ...
                              <div class="layer-admin" id="textAreaMessage">
                                <div class="peers fxw-nw ai-c pY-3 pX-10 bgc-white bdrs-2 lh-3/2">
                                  <div class="peer mL-10 ord-1">
                                    <small>10:00 AM</small>
                                  </div>
                                  <div class="peer-greed ord-0 chat-admin">
                                    <span>??</span>
                                  </div>
                              </div>
                            </div>
                    ...
                    <div class="layer w-100">
                      ...
                      <div class="p-20 bdT bgc-white">
                        <div class="pos-r">
                          <input type="text" id="textMessage" class="form-control bdrs-10em m-0" placeholder="Say something...">
                          <button onclick="sendMessageee();" type="button" class="btn btn-primary bdrs-50p w-2r p-0 h-2r pos-a r-1 t-1">
                            <i class="fa fa-paper-plane-o"></i>
                          </button>
                        </div>
                      </div>
         ...
         <script type="text/javascript">
			...
			function sendMessageee() {
				var form=document.querySelector(".layer-admin")
				if (typeof websocket != 'undefined' && websocket.readyState == WebSocket.OPEN) {
					...
					console.log(form);
					 ...
					 div.className="peer-greed ord-0 chat-admin";
