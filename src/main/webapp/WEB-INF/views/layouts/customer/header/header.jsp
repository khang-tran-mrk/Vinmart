                ...
                <nav class="menu-hover"> <span><i class="bhx-navmenu"></i> DANH MỤC SẢN PHẨM</span>
                    <ul class="colmenu-ul">
                    	...
                    	<li class="productpromo-count">
                    		<a href="/khuyen-mai">
                    			<i class="bhx-productpromo"></i><strong class="number">871</strong> sản phẩm khuyến mãi
                    		</a>
                    	</li>
                    	<li class="product-expired">
                    		<a href="/khuyen-mai/xa-kho-gia-soc"><i class="bhx-productexpired"></i>Xả kho giá sốc
                    		</a>
                    	</li>
                    	<li class="store-count">
                    		<a href="/he-thong-sieu-thi"><i class="bhx-storecount"></i>Danh sách <strong>1.755</strong> cửa hàng
                    		</a>
                    	</li>
                    	 <!-- END GIOI THIEU -->
                    </ul>
