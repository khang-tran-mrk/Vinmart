...
public class UserController extends BaseController {
	...
	public ModelAndView CreateAccount(@ModelAttribute("user") Users user, @ModelAttribute("customer") Customers customer) {
		...
		if(action.equals("guimail")) {
			...
			if( check==true) {
				if (success) 
				{
					...
					model.addAttribute("success", "Kiểm tra email để thay đổi mật khẩu !");
