...
public class proController  extends BaseController{
	...
	//Thực hiện ADD product old 
		...
		public String doAddproductOld(
				@RequestParam("product_id") int product_id,
				@RequestParam("product_soluongtonkho") int product_soluongtonkho,
		...
		@RequestMapping(value ="/del-product/{product_id}", method= RequestMethod.GET)
		public String xoaProduct(@PathVariable int product_id) {
