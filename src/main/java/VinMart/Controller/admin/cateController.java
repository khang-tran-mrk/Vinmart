...
public class cateController extends BaseController {
	...
	public String doAddcate(@RequestParam("category_name") String category_name, @RequestParam("p_id") int p_id,
			HttpSession sess) {
	...
	public String doEditcate(@RequestParam("category_id") int category_id,
			@RequestParam("category_name") String category_name, @RequestParam("p_id") int p_id, ModelMap model) {
