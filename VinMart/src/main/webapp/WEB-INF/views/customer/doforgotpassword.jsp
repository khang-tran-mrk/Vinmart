                  ...
                  <div class="MuiFormControl-root MuiTextField-root MuiFormControl-marginDense">
                   <input type="hidden" value ="<%=pass.getString("users_email")%>" name="users_email">
                    <div class="MuiInputBase-root MuiOutlinedInput-root MuiInputBase-formControl MuiInputBase-marginDense MuiOutlinedInput-marginDense">
                      <input required aria-invalid="false" name="password" type="password" class="MuiInputBase-input MuiOutlinedInput-input MuiInputBase-inputMarginDense MuiOutlinedInput-inputMarginDense" value="" placeholder="Nhập mật khẩu mới ">
                    ...
                    <div class="mb-24"></div>
                    <div class="MuiInputBase-root MuiOutlinedInput-root MuiInputBase-formControl MuiInputBase-marginDense MuiOutlinedInput-marginDense">
                      <input required aria-invalid="false" name="repassword" type="password" class="MuiInputBase-input MuiOutlinedInput-input MuiInputBase-inputMarginDense MuiOutlinedInput-inputMarginDense" value="" placeholder="Xác nhận lại mật khẩu mới">
                      <fieldset aria-hidden="true" class="jss4 MuiOutlinedInput-notchedOutline">
