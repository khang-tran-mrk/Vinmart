		...
		$(document).ready(function() {
	        $('.edit').on('click',
	            function() {
	                ...
	                var product_price=$(this).parent().find('#product_price').val();
	                var product_discount=$(this).parent().find('#product_discount').val();
	                var product_danhmuc=$(this).parent().find('#product_danhmuc').val();
	                var product_image=$(this).parent().find('#product_image').val();
	                var product_view=$(this).parent().find('#product_view').val();
	                var product_purchased=$(this).parent().find('#product_purchased').val();
	                var product_trangthai=$(this).parent().find('#product_trangthai').val();
	                var MaNCC=$(this).parent().find('#MaNCC').val();
	                var product_thuonghieu=$(this).parent().find('#product_thuonghieu').val();
	                var product_sanxuat=$(this).parent().find('#product_sanxuat').val();
	                var product_thanhphan=$(this).parent().find('#product_thanhphan').val();
	                var product_nongdocon=$(this).parent().find('#product_nongdocon').val();
	                var product_luongga=$(this).parent().find('#product_luongga').val();
	                var product_luongduong=$(this).parent().find('#product_luongduong').val();
	                var product_thetich=$(this).parent().find('#product_thetich').val();
	                var product_baoquan=$(this).parent().find('#product_baoquan').val();
	                var product_sudung=$(this).parent().find('#product_sudung').val();
	                var product_soluongtonkho=$(this).parent().find('#product_soluongtonkho').val();
	                var product_nsx=$(this).parent().find('#product_nsx').val();
	                var product_hsd=$(this).parent().find('#product_hsd').val();
	                var product_content=$(this).parent().find('#product_content').val();
	
	                $('#product_update #product_id').val(product_id);
	                $('#product_update #product_name').val(product_name);
	                $('#product_update #product_price').val(product_price);
	                $('#product_update #product_discount').val(product_discount);
	                $('#product_update #product_danhmuc').val(product_danhmuc);
	                $('#product_update #product_image').val(product_image);
	                $('#product_update #product_view').val(product_view);
	                $('#product_update #product_purchased').val(product_purchased);
	                $('#product_update #product_trangthai').val(product_trangthai);
	                $('#product_update #MaNCC').val(MaNCC);
	                $('#product_update #product_thuonghieu').val(product_thuonghieu);
	                $('#product_update #product_sanxuat').val(product_sanxuat);
	                $('#product_update #product_thanhphan').val(product_thanhphan);
	                $('#product_update #product_nongdocon').val(product_nongdocon);
	                $('#product_update #product_luongga').val(product_luongga);
	                $('#product_update #product_luongduong').val(product_luongduong);
	                $('#product_update #product_thetich').val(product_thetich);
	                $('#product_update #product_baoquan').val(product_baoquan);
	                $('#product_update #product_sudung').val(product_sudung);
	                $('#product_update #product_soluongtonkho').val(product_soluongtonkho);
	                $('#product_update #product_nsx').val(product_nsx);
	                $('#product_update #product_hsd').val(product_hsd);
	                $('#product_update #product_content').val(product_content);
	
	                $.ajax({url : "${pageContext.request.contextPath}/edit-product/"+ id,
	                        contentType : "application/json",
	                        dataType : "json",
	                        type : "GET",
	                        success : function(data) {
	                            $('#product_update #product_id').val(id);
	                            $('#product_update #product_name').val(product_name);
	                            $('#product_update #product_price').val(product_price);
	                            $('#product_update #product_discount').val(product_discount);
	                            $('#product_update #product_danhmuc').val(product_danhmuc);
